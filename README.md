...
# SABR Hagan approximation formulas

	1. acq_options_sabr_blackvol - Compute LogNormal (Black) implied vol from SABR parameters (alpha, beta, rho, nu - vol of vol )
	2. acq_options_sabr_normvol -  Compute Normal (Bachelier) implied vol from SABR parameters (alpha, beta, rho, nu - vol of vol )
